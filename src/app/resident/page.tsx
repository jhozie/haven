...
export default function ResidentDashboard() {
    ...
    const [payingChargeRef, setPayingChargeRef] = useState<string | null>(null);
    ...
    const onPaystackSuccess = (reference: any) => {
        // Payment complete! Mark all pending charges for this user as paid.
    ...
    const handlePayAll = () => {
        ...
        initializePayment({
            ...
            onSuccess: onPaystackSuccess as any,
